...
public class Demo014 {
    ...
    private TableRuleConfiguration orderRule(){
        ...
        orderTableRuleConfig.setDatabaseShardingStrategyConfig(
                new StandardShardingStrategyConfiguration("user_id",
                        (names, value) -> {
                            return "ds" + ((Integer)(value.getValue()) % 2);
                        },
                        (names, value) -> {
    ...
    public void insert() throws SQLException {
        ...
        for(int i=0;i<50;i++){
            List<Object> orderParams = Arrays.asList(i, i%7, i%3, "init", "mark:"+i, i%8);
    ...
    public void selectTest() throws SQLException {
        ...
        //String sql = "select * from t_order o where o.user_id in (0,6,5,7) and o.order_id = 2 ";
        String sql = "select * from t_order o where o.user_id in (?,?) and o.order_id in(?, ?)";
        Connection conn = dataSource.getConnection();
        ...
        System.out.println("=============");
        //Connection conn02 = dataSource.getConnection();
